                          ...
                          onPressed: () async {
                            ...
                            if (_model.uploadedFileUrl1.isEmpty) {
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
                                  content: Text(
                                    'Kindly upload your aadhaar card.',
                                    style: TextStyle(
                                      color: FlutterFlowTheme.of(context)
                                          .primaryText,
                                    ),
                            ...
                            await currentUserReference!
                                .update(createUsersRecordData(
                              userDocuments: updateDocumentsStruct(
                                DocumentsStruct(
                                  aadhaarCard: _model.uploadedFileUrl1,
                                  photo: _model.uploadedFileUrl2,
                                  signature: _model.uploadedFileUrl3,
                                ),
                                clearUnsetFields: false,
                              ),
                            ));
