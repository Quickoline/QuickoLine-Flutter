                                                      ...
                                                      Padding(
                                                        ...
                                                        child: Text(
                                                          FFLocalizations.of(
                                                                  context)
                                                              .getText(
                                                            'jnuqgje3' /* Let's get started by filling o... */,
                                                          ),
                                                          textAlign:
                                                              TextAlign.start,
                                                                  ...
                                                                  Padding(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      onTap:
                                                                          () async {
                                                                        await launchURL(
                                                                            'http://quickoline.com/policy/');
                                                                      },
                                                                      child:
                                                                          Text(
                                                                        FFLocalizations.of(context)
                                                                            .getText(
                                                                          'vdd2drg2' /* I agree to Terms & Conditons */,
                                                                        ),
                                                                        style: FlutterFlowTheme.of(context)
                                                                            .bodyMedium
                                                                            .override(
                                                              ...
                                                              if (_model
                                                                ...
                                                                ScaffoldMessenger.of(
                                                                  ...
                                                                  SnackBar(
                                                                    content:
                                                                        Text(
                                                                      'Agreement of privacy policy and whatsapp number is required.',
                                                                      style:
                                                                          TextStyle(
                                                                        color: FlutterFlowTheme.of(context)
                                                                            .primaryText,
                                                      ...
                                                      Padding(
                                                        ...
                                                        child: Text(
                                                          FFLocalizations.of(
                                                                  context)
                                                              .getText(
                                                            '6rrmq56y' /* Fill out the information below... */,
                                                          ),
                                                          textAlign:
                                                              TextAlign.start,
                                                          style: FlutterFlowTheme
