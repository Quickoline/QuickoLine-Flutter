                ...
                children: [
                  ...
                  Expanded(
                    child: Padding(
                      ...
                      child: StreamBuilder<List<LegalRecord>>(
                        stream: queryLegalRecord(),
                        builder: (context, snapshot) {
                          ...
                          List<LegalRecord> listViewLegalRecordList =
                              snapshot.data!;
                          return ListView.builder(
                            padding: EdgeInsets.zero,
                            scrollDirection: Axis.vertical,
                            itemCount: listViewLegalRecordList.length,
                            itemBuilder: (context, listViewIndex) {
                              final listViewLegalRecord =
                                  listViewLegalRecordList[listViewIndex];
                              return Padding(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    context.pushNamed(
                                      'legalDetails',
                                      queryParameters: {
                                        'legaldetails': serializeParam(
                                          listViewLegalRecord,
                                          ParamType.Document,
                                        ),
                                      }.withoutNulls,
                                      extra: <String, dynamic>{
                                        'legaldetails': listViewLegalRecord,
                                      },
                                    );
                                  },
                                  child: Container(
