...
class UploadScreenWidget extends StatefulWidget {
  const UploadScreenWidget({
    super.key,
    required this.simpleFormName,
    required this.send,
  });

  final DocumentReference? simpleFormName;
  final List<DocumentStruct>? send;
...
class _UploadScreenWidgetState extends State<UploadScreenWidget>
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      setState(() {
        _model.savePhoto = widget.send!.toList().cast<DocumentStruct>();
      });
    });
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Builder(
                                    builder: (context) {
                                      final allDocuments =
                                          _model.savePhoto.toList();
                                      return SingleChildScrollView(
                                        child: Column(
                                          mainAxisSize: MainAxisSize.max,
                                          children:
                                              List.generate(allDocuments.length,
                                                  (allDocumentsIndex) {
                                            final allDocumentsItem =
                                                allDocuments[allDocumentsIndex];
                                            return Padding(
